...
- If the Trial is running it will calculate how long before Tiamat dies based on her current HP and total DPS and check again after one-fifth that much time or 8 hours (whichever is shorter).
